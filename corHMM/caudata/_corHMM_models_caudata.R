...
# This is an auxiliary script for `_run_corHMM_caudata.R`. It builds and plots the models
...
q$terrestrial_v1_ard$rate.mat[3,1]<-2


q$terrestrial_v1_ard$rate.mat[1,4]<-3
q$terrestrial_v1_ard$rate.mat[2,4]<-4
q$terrestrial_v1_ard$rate.mat[5,1]<-5

q$terrestrial_v1_ard$rate.mat[4,1]<-6
q$terrestrial_v1_ard$rate.mat[4,2]<-7
q$terrestrial_v1_ard$rate.mat[1,5]<-8
...
q$terrestrial_v1_sym$rate.mat[1,4]<-2
q$terrestrial_v1_sym$rate.mat[2,4]<-3
q$terrestrial_v1_sym$rate.mat[5,1]<-4

q$terrestrial_v1_sym$rate.mat[4,1]<-2
q$terrestrial_v1_sym$rate.mat[4,2]<-3
...
q$terrestrial_v1_er$rate.mat[1,4]<-1
q$terrestrial_v1_er$rate.mat[2,4]<-1
q$terrestrial_v1_er$rate.mat[5,1]<-1

q$terrestrial_v1_er$rate.mat[4,1]<-1
q$terrestrial_v1_er$rate.mat[4,2]<-1
...
q$terrestrial_v2_ard$rate.mat[3,1]<-2


q$terrestrial_v2_ard$rate.mat[1,4]<-3
q$terrestrial_v2_ard$rate.mat[2,4]<-4
q$terrestrial_v2_ard$rate.mat[5,4]<-5

q$terrestrial_v2_ard$rate.mat[4,1]<-6
q$terrestrial_v2_ard$rate.mat[4,2]<-7
q$terrestrial_v2_ard$rate.mat[4,5]<-8
...
q$terrestrial_v2_sym$rate.mat[1,4]<-2
q$terrestrial_v2_sym$rate.mat[2,4]<-3
q$terrestrial_v2_sym$rate.mat[5,4]<-4

q$terrestrial_v2_sym$rate.mat[4,1]<-2
q$terrestrial_v2_sym$rate.mat[4,2]<-3
q$terrestrial_v2_sym$rate.mat[4,5]<-4
...
q$terrestrial_v2_er$rate.mat[1,4]<-1
q$terrestrial_v2_er$rate.mat[2,4]<-1
q$terrestrial_v2_er$rate.mat[5,4]<-1

q$terrestrial_v2_er$rate.mat[4,1]<-1
q$terrestrial_v2_er$rate.mat[4,2]<-1
q$terrestrial_v2_er$rate.mat[4,5]<-1
...
# plot all models (observed states only)

par(mfrow=c(6,3))
plot.order<-c(1,4,3,2,5)
...
for(i in 1:length(q)){
  ...
  if(q[[i]]$rate.cat==1){
    ...
    qgraph(q[[i]]$rate.mat[plot.order, plot.order],
           ...
           node.height=0.5,
           #label.cex=3,
           label.color=c("#24b9e9", "#009E73","gold","#55FF7E", "#f6776f"),
           # edges:
           fade=F,
           esize=1.5,
           edge.labels=T,
