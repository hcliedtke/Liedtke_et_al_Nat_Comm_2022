...
# This script was used to model trait evolution using the secsse package, for the Gymnophiona
...
saveRDS(models,"secsse_models_gymno.rds")
...
best_params<-best_model$MLpars[[1]] %>%
  ...
  mutate(observed = c("1"="S",
                      "2"="D",
                      "3"="V")[as.character(observed)])
