...
# This script was used to evaluate the MCMC outputs from BayesTraits, for the Gymnophiona
...
setwd("~/Documents/amphibian_diversity_project/2021/_SI_scripts/BayesTraits/gymno/")
