...
# This script was used to evaluate the MCMC outputs from BayesTraits, for the Anura
...
setwd("~/Documents/amphibian_diversity_project/2021/_SI_scripts/BayesTraits/anura/")
...
qgraph(non_zero_rates,
       ...
       edge.labels=T,
       edge.label.cex=2,
       minimum=45, # threshold for edges to include
       edge.width=1.5,
       posCol="black",
       fade=T,
       colFactor=0.9,
